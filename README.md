...
[Dreamhack](https://dreamhack.io/) 워게임 취약점 분석 및 익스플로잇 기록 저장소입니다.
각 분야별 취약점의 Root Cause를 파악하고, 재현 가능한 분석 보고서 작성을 목표로 합니다.

## 분야별 목록

| Domain | Link | Challenges |
| :--- | :--- | :---: |
| Web Hacking | [web/](./web/) | 18 |
...
| [mongoboard](./web/BRONZE/mongoboard) | B3 | Express, MongoDB, IDOR |
| [DreamDocs](./web/BRONZE/DreamDocs) | B3 | Flask, Auth Bypass, IDOR |
| [BypassIF](./web/BRONZE/BypassIF) | B3 | Flask, Command Injection |
